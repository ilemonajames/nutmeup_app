...
import 'package:nutmeup/models/Mechanic/MechanicModel.dart' as mechanic;
...
class CreateMechanic extends StatefulWidget {
  const CreateMechanic({Key? key}) : super(key: key);

  @override
  State<CreateMechanic> createState() => _CreateMechanicState();
}

class _CreateMechanicState extends State<CreateMechanic> with Extra {
...
// End of phone number section
                    ...
                    CustomButton(
                        ...
                        onClick: () async {
                          ...
                          mechanic.MechanicModel model = mechanic.MechanicModel(
                              name: _name,
                              phone: _phone,
